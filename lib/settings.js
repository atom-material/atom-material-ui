...
function init() {
    ...
    toggleClass(atom.config.get('atom-material-ui.tabs.noTabMaxWidth'), 'no-tab-max-width');
...
function apply() {
    ...
    atom.config.onDidChange('atom-material-ui.tabs.noTabMaxWidth', (value) => toggleClass(value.newValue, 'no-tab-max-width'));
